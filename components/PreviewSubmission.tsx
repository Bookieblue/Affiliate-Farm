  ...
  return (
    <div className="bg-gray-40 p-6 h-fit rounded-lg">
      ...
      <div className="flexCenter w-full">
        <div className="w-[70%] bg-black-60 rounded-xl h-fit mt-7">
        <Programs />
        </div>
      </div>
      <div className="regular-16 grid grid-cols-3 mt-10 gap-5">
        <div>
      ...
      <NestedDialog
          ...
          >
            <Button className="w-full mt-3">Promote Affiliate Program</Button>
            <Button variant='outline' className="w-full bg-[#C2BDB9]" >Go To Homepage</Button>
      </NestedDialog>
    </div>
  );
};
